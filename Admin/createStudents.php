...
function getClassArmId($conn, $classArmName,$classId)
{
    $classArmQuery = mysqli_query($conn, "SELECT Id FROM tblclassarms WHERE classArmName = '$classArmName' and classId = '$classId'");
      ...
      try {
          ...
          foreach ($data as $row) {
              if (!empty($row['0']) && !empty($row['1']) && !empty($row['2']) && !empty($row['3']) && !empty($row['4'])) {
                  ...
                  $classArmId = getClassArmId($conn, $classArmName,$classId);
