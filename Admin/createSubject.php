...
if(isset($_POST['save'])){
    ...
    $query=mysqli_query($conn,"select * from tblsubject where Subject ='$Subject'");
    ...
    if($ret > 0){ 
        ...
        $query=mysqli_query($conn,"insert into tblsubject(Subject) value('$Subject')");
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        if(isset($_POST['update'])){
           ...
           $Id = $_POST['Id'];
           $query=mysqli_query($conn,"update tblsubject set Subject='$Subject'  where Id='$Id'");
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="Subject" value="<?php echo $row['Subject'];?>" id="exampleInputFirstName" placeholder="Subject">
                        </div>
