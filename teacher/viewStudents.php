              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  $selectedSubjectId = isset($_POST['selectedSubject']) ? $_POST['selectedSubject'] : null;
                      ...
                      $query = $query = "SELECT tblstudents.Id, tblclass.className, tblclassarms.classArmName, tblclassarms.Id AS classArmId, tblstudents.firstName,
                      tblstudents.lastName, tblstudents.Enrollment_no, tblstudents.dateCreated
                      FROM tblstudents
                      INNER JOIN tblclass ON tblclass.Id = tblstudents.classId
                      INNER JOIN tblclassarms ON tblclassarms.Id = tblstudents.classArmId
                      WHERE tblstudents.classId = '$selectedClassId'
                         AND tblstudents.classArmId = '$selectedSectionId'";
;
