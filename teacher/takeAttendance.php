...
if ($count == 0) {
    ...
    while ($ros = $qus->fetch_assoc()) {
        $qquery = mysqli_query($conn, "INSERT INTO tblattendance(Enrollment_no,classId,classArmId,sessionTermId,status,dateTimeTaken) 
                                       VALUES ('$ros[Enrollment_no]','$selectedClassId','$selectedSectionId','$sessionTermId','0','$dateTaken')");
    }
}
            ...
            <div class="row">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">All Student in (<?php echo $rrw['$selectedClassId'].' - '.$rrw['$selectedSectionId'];?>) Class</h6>
                ...
                <?php echo $statusMsg; ?>
                  ...
                  <?php
                      ...
                      where tblstudents.classId = '$selectedClassId' and tblstudents.classArmId = '$selectedClassId'";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
